...
const disabled = isSubmitting || disableSubmit;
  return (<div className="flex justify-center space-x-3 pt-4">
    ...
    <Button type="button" onClick={onSubmit} disabled={disabled} variant="default" className="cursor-pointer bg-[var(--color-primary)] hover:bg-[var(--color-primary)]/90 text-white py-3" >
      {isSubmitting ? (
        <>
