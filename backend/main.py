...
import uvicorn
from cataloger.routers import ai, person, text, editions, translation, annotation, bdrc, category, language, role, tokenize, alignment, admin, segments
...
app.include_router(alignment.router, prefix="/aligner", tags=["aligner"])
